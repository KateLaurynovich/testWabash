...
public class BrowserFactory {
            ...
            try {
                switch (PropertiesManager.getProperty("browser")) {
                    case "chrome":
                        ...
                        webDriver = new RemoteWebDriver(URI.create(PropertiesManager.getProperty("selenoidLink")).toURL(), capabilities);
    ...
    private static ChromeOptions chromeOptions() {
        String pathForDownload = PropertiesManager.getProperty("path");
        HashMap<String, Object> chromePrefs = new HashMap<String, Object>();
        chromePrefs.put("intl.accept_languages", PropertiesManager.getProperty("locale"));
        ...
        if (Boolean.valueOf(PropertiesManager.getProperty("headless"))) {
    ...
    private static FirefoxOptions fireFoxOptions() {
        ...
        String pathToDownload = PropertiesManager.getProperty("pathDownloads");
        options.addPreference("intl.accept_languages", PropertiesManager.getProperty("locale"));
    ...
    public static WebDriver getDriver() {
        switch (PropertiesManager.getProperty("remote")) {
            case "true":
